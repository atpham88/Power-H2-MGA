...
*SIZE PARAMETERS [GW]
         ...
         pMaxZCaptech(tech)                  max capacity allowed to be built by zone [MW]
...
$load pNMaxWind, pNMaxSolar, pNMaxNuclear, pNMaxCC, pNMaxCCS, pNMaxDACS, pPMaxSto, pEMaxSto, pCapactech, pHrtech, pOpcosttech, pMaxZCaptech, pWeighttech
