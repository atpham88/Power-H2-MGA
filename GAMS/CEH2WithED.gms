...
Model ceH2WithED includes all equations /all/;
solve ceH2WithED using lp minimizing vZannual;

pModelstat = ceH2WithED.Modelstat;
pSolvestat = ceH2WithED.solvestat;
