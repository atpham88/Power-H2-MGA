...
$include CESharedFeaturesH2.gms
$include StorageEDModule.gms
$include EDVarsAndConstraints.gms
$include CETimeDependentConstraintsH2.gms
...
Equations
*Total cost buffers
         objfunclimit                    sum investment and variable costs limit
*Cost equations
         objfunc                         objective function = sum of weighted non-zero capacity
...
objfunclimit..           vFixedcostannual + vVarcostannual =l= pObjLimit;
************************************************************
