    ...
    for latIdx in range(len(lats)):
        for lonIdx in range(len(lons)):
            ...
            if existingCap > 0 or coordCfs.sum() > 0: #filter out coords w/ no gen
                if existingCap < (density*1000*3014)/1000: #1000 to get to kW/km^2; 3014 for km^2 of lat/long box per https://www.usgs.gov/faqs/how-much-distance-does-a-degree-minute-and-second-cover-your-maps?qt-news_science_products=0#qt-news_science_products            
