...
setInitSOCblock1h(ststorageegu).. vInitSOCblock1h(ststorageegu) =e= 
                                    pInitSOC;
setInitSOCblockpeaktotal2h(ststorageegu).. vInitSOCblockpeaktotal2h(ststorageegu) =e= 
                                    pInitSOC;
setInitSOCblockpeaknet3h(ststorageegu).. vInitSOCblockpeaknet3h(ststorageegu) =e= 
                                    pInitSOC;
setInitSOCblock4h(ststorageegu).. vInitSOCblock4h(ststorageegu) =e= 
                                    pInitSOC;
setInitSOCblock5h(ststorageegu).. vInitSOCblock5h(ststorageegu) =e= 
                                    pInitSOC;
setInitSOCblockpeaknetramp6h(ststorageegu).. vInitSOCblockpeaknetramp6h(ststorageegu) =e= 
                                    pInitSOC;

defSOCtech(storagetech,h).. vStateofchargetech(storagetech,h) =e= pInitSOCblock0htech(storagetech)$[ord(h)=pHourInitblock0h]*vEneBuiltSto(storagetech) + vInitSOCblock1htech(storagetech)$[ord(h)=pHourInitblock1h] + vInitSOCblockpeaktotal2htech(storagetech)$[ord(h)=pHourInitblockpeaktotal2h] + vInitSOCblockpeaknet3htech(storagetech)$[ord(h)=pHourInitblockpeaknet3h] + vInitSOCblock4htech(storagetech)$[ord(h)=pHourInitblock4h] + vInitSOCblock5htech(storagetech)$[ord(h)=pHourInitblock5h] + vInitSOCblockpeaknetramp6htech(storagetech)$[ord(h)=pHourInitblockpeaknetramp6h] +
...
genPlusUpResToSOCtech(storagetech,h).. vGentech(storagetech,h)+vReguptech(storagetech,h)+vFlextech(storagetech,h)+vConttech(storagetech,h) =l= vStateofchargetech(storagetech, h-1)$nonInitH(h)
                     + pInitSOCblock0htech(storagetech)$[ord(h)=pHourInitblock0h]*vEneBuiltSto(storagetech) + vInitSOCblock1htech(storagetech)$[ord(h)=pHourInitblock1h] + vInitSOCblockpeaktotal2htech(storagetech)$[ord(h)=pHourInitblockpeaktotal2h] + vInitSOCblockpeaknet3htech(storagetech)$[ord(h)=pHourInitblockpeaknet3h] + vInitSOCblock4htech(storagetech)$[ord(h)=pHourInitblock4h] + vInitSOCblock5htech(storagetech)$[ord(h)=pHourInitblock5h] + vInitSOCblockpeaknetramp6htech(storagetech)$[ord(h)=pHourInitblockpeaknetramp6h];
...
defChangeSOCblock0htech(ltstoragetech).. vChangeSOCblock0htech(ltstoragetech) =e= vFinalSOCblock0htech(ltstoragetech) 
                              - pInitSOCblock0htech(ltstoragetech)*vEneBuiltSto(ltstoragetech);
...
setInitSOCblock1htech(ststoragetech).. vInitSOCblock1htech(ststoragetech) =e= 
                                    pInitSOCtech*vEneBuiltSto(ststoragetech);
setInitSOCblockpeaktotal2htech(ststoragetech).. vInitSOCblockpeaktotal2htech(ststoragetech) =e= 
                                    pInitSOCtech*vEneBuiltSto(ststoragetech);
setInitSOCblockpeaknet3htech(ststoragetech).. vInitSOCblockpeaknet3htech(ststoragetech) =e= 
                                    pInitSOCtech*vEneBuiltSto(ststoragetech);
setInitSOCblock4htech(ststoragetech).. vInitSOCblock4htech(ststoragetech) =e= 
                                    pInitSOCtech*vEneBuiltSto(ststoragetech);
setInitSOCblock5htech(ststoragetech).. vInitSOCblock5htech(ststoragetech) =e= 
                                    pInitSOCtech*vEneBuiltSto(ststoragetech);
setInitSOCblockpeaknetramp6htech(ststoragetech).. vInitSOCblockpeaknetramp6htech(ststoragetech) =e= 
                                    pInitSOCtech*vEneBuiltSto(ststoragetech);
